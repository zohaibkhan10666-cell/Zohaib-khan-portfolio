...
export function LinkedinIcon({ className = "w-4 h-4" }: { className?: string }) {
  return (
    <svg className={className} viewBox="0 0 24 24" fill="currentColor">
      <path d="M6.94 5a2 2 0 1 1-4-.01 2 2 0 0 1 4 .01zM7 8.48H3V21h4zM13.5 8.48h-3.8V21h3.8v-6.3c0-1.66.31-3.27 2.38-3.27 2.04 0 2.07 1.9 2.07 3.38V21H22v-6.9c0-3.62-.78-6.4-5.02-6.4-2.03 0-3.4 1.12-3.96 2.18h-.05z"/>
    </svg>
  );
}
